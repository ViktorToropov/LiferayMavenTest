...
/**
 * Provides the local service utility for GetDb. This utility wraps
 * <code>com.lr.getdb.service.impl.GetDbLocalServiceImpl</code> and
 ...
 * @generated
 */
public class GetDbLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.lr.getdb.service.impl.GetDbLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static GetDb addGetDb(GetDb getDb) {
		return getService().addGetDb(getDb);
	}
	 ...
	 */
	public static GetDb createGetDb(long Id) {
		return getService().createGetDb(Id);
	}
	 ...
	 */
	public static GetDb deleteGetDb(GetDb getDb) {
		return getService().deleteGetDb(getDb);
	}
	 ...
	 */
	public static GetDb deleteGetDb(long Id) throws PortalException {
		return getService().deleteGetDb(Id);
	}
	...
	public static GetDb fetchGetDb(long Id) {
		return getService().fetchGetDb(Id);
	}
	 ...
	 * @throws PortalException if a get db with the primary key could not be found
	 */
	public static GetDb getGetDb(long Id) throws PortalException {
		return getService().getGetDb(Id);
	}
	 ...
	 */
	public static List<GetDb> getGetDbs(int start, int end) {
		return getService().getGetDbs(start, end);
	}
	 ...
	 */
	public static int getGetDbsCount() {
		return getService().getGetDbsCount();
	}
	 ...
	 */
	public static GetDb updateGetDb(GetDb getDb) {
		return getService().updateGetDb(getDb);
	}

	public static GetDbLocalService getService() {
		return _service;
	}

	private static volatile GetDbLocalService _service;
